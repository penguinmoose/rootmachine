/* big.js v5.2.2 https://github.com/MikeMcl/big.js/LICENCE */ ! function(e) {
  "use strict";
  var r, i = 20,
    s = 1,
    P = 1e6,
  ...
  function R(e, r, t, n) {
    ...
    if (s < i.length) {
      if (1 === t) n = 5 <= i[s];
      else if (2 === t) n = 5 < i[s] || 5 == i[s] && (n || s < 0 || i[s + 1] !== D || 1 & i[s - 1]);
      else if (3 === t) n = n || !!i[0];
      else if (n = !1, 0 !== t) throw Error(h);
      if (s < 1) i.length = 1, n ? (e.e = -r, i[0] = 1) : i[0] = e.e = 0;
      else {
        if (i.length = s--, n)
  ...
  function t(e, r, t, n) {
    ...
    if (i = e.e, t = (s = e.c.join("")).length, 2 != r && (1 == r || 3 == r && n <= i || i <= o.NE || i >= o.PE)) s = s.charAt(0) + (1 < t ? "." + s.slice(1) : "") + (i < 0 ? "e" : "e+") + i;
    else if (i < 0) {
      for (; ++i;) s = "0" + s;
      s = "0." + s
    } else if (0 < i)
    ...
    if (f = h - a) {
      ...
      for (t = ((i = u.length < l.length) ? u : l).length, f = c = 0; c < t; c++)
        if (u[c] != l[c]) {
          i = u[c] < l[c];
          break
        } if (i && (n = u, u = l, l = n, e.s = -e.s), 0 < (c = (t = l.length) - (r = u.length)))
      for (; c--;) u[r++] = 0;
    for (c = r; f < t;) {
      if (u[--t] < l[t]) {
        for (r = t; r && !u[--r];) u[r] = 9;
